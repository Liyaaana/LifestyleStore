...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Campentre!</h1>
                    <p>We have the best decor items, cakes and cookies for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/painting.jpeg" alt="painting">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>painting</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/giftcard.jpg" alt="giftcard">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>giftcard</h3>
